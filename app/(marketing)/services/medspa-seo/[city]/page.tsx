...
const SERVICE_SLUG = "medspa-seo";
const VERTICAL = "medspa" as const;
...
export async function generateMetadata({
  ...
  return buildLocationMetadata(service, cityData, VERTICAL);
}
...
export default async function Page({
  ...
  const { city } = await params;
  const { service, city: cityData } = getLocationData(SERVICE_SLUG, city);
  const locationService = buildLocationServiceData(service, cityData, VERTICAL);
