...
function LoginSkeleton() {
  return (
    <div className="w-full max-w-md space-y-8 animate-pulse">
      <div className="text-center">
        <div className="mx-auto h-9 w-48 rounded-lg bg-[var(--color-border)]" />
        <div className="mx-auto mt-2 h-4 w-40 rounded bg-[var(--color-border)]" />
      </div>
      <div className="rounded-2xl border border-[var(--color-border)] bg-white p-8 shadow-sm space-y-3">
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <div className="h-3 w-4 rounded bg-[var(--color-border)]" />
          <div className="h-px flex-1 bg-[var(--color-border)]" />
        </div>
        <div className="h-12 w-full rounded-full bg-[var(--color-border)]" />
        <div className="mx-auto mt-6 h-3 w-56 rounded bg-[var(--color-border)]" />
      </div>
    </div>
  );
}
