...
featured_image_prompt: "A smartphone held up in front of a charming independent restaurant storefront on a sunny street, a single stylized glowing location pin floating above the screen, evoking being found on a local map without showing any real app. Photorealistic editorial photograph, warm natural light, shallow depth of field, premium and inviting mood, palette of warm cream, soft charcoal and subtle terracotta accents, wide 16:9 composition with clean negative space on one side for a title overlay, no text, no logos, no watermarks, no brand names, no app interface screens."
status: draft
reading_time: 7
---
...
2. **Distance.** How close you are to the searcher (or to the area they searched).
3. **Prominence.** How well known and trusted your restaurant is, based on reviews, links, and your overall online presence.
...
A complete profile tells Google you are a real, active business, and it gives the algorithm more ways to match you to searches. We cover this in depth in our [Google Business Profile optimization service](/services/google-business-profile-optimization).
...
This is core [restaurant SEO](/services/restaurant-seo) work, and it reinforces the relevance signals your Google profile is sending.
...
2. Keep your name, address, and phone consistent everywhere.
3. Build a steady flow of recent reviews and respond to them.
4. Add real photos regularly.
5. Optimize your website for local search.
6. Earn a few genuine local links.

If you would rather have a team handle all of this, that is exactly what we do. [Get a free consultation](/contact) and we will map out a plan to get your restaurant into the local pack.
